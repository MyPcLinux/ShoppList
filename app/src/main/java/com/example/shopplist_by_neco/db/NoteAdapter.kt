...
import com.example.shopplist_by_neco.databinding.NoteListItemBinding
    ...
    class ItemHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        companion object{
            fun create(parent: ViewGroup): ItemHolder{
                return ItemHolder(LayoutInflater.from(
                    parent.context).inflate(R.layout.note_list_item, parent, false))
            }
        }
    }
